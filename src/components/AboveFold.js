    ...
    if (isMobile) {
      return(
        <div>
          ...
          <h5 class='pb-2'>Hey there, I’m Janet Peng</h5>
          <h2 class='pb-2'>Junior studying Product Design @ 
              <a href='https://www.design.cmu.edu/' target="_blank" class='link'>CMU</a></h2>
          <h2>Content Developer and UX Design Team Lead @ 
              <a href='https://academy.cs.cmu.edu/' target="_blank" class='link'>CMU CS Academy</a></h2>
          <div class='py-3'>
            <p>I love designing experiences, especially if they are 
              ...
              it a large part of my design process. </p>
            <p>Besides design, I enjoy exploring new skills such as programming, 
              illustration, photography, and baking. I am interested in technology and 
              am persuing a minor in Computer Science.</p>
          </div>
          </Container>
        </div>
      )
