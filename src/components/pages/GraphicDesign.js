...
import HeartDecisions from './HeartDecisions.js'
...
class GraphicDesign extends React.Component {
       constructor(props){
              super(props)
              this.state = {
                tabs: ['Journal layout', 'Card game', 'Explanatory book', 'Systems map'],
                tabStates: [ true, false, false, false]
              }
            ...
            render(){
              ...
              if (this.state.tabStates[1]) {
                ...
                page = <Mixer/>
              } else if (this.state.tabStates[3]) {
                page = <Systems/>
              }
              return (
                  <div class='pt-4'>
                      <SectionTitleWithBack name='Graphic Design'
                                            page='/play'/>
                      <TitledContent title='Description'
