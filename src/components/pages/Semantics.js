        ...
        <div class='pt-5'>
            ...
            <TitledContent title='Description'
                           body= 'Explore the semantics of form and how they encourage 
                                  ...
                                  foam, clay, and wood explorations. Projects include a 
            ...
            <div>
                ...
                <TitledContent title='Description'
                               body="Design a working wood and rubber mechanism and accompanying 
                                    ...
                                    feel."/>
                <ContentBlock body="My mechanism's interaction is a subtle squeezing 
                ...
                <TitledContent title='Process'
                               body= 'I started by familiarizing myself with the
                               amount of stretch and tension different rubber bands
                               afforded. With more information about the behaviors of the 
                               rubber bands, I began exploring some possible 
                               interactions through sketching and rapid prototyping with 
                               foam core. I considered motions such as
                               pushing, pulling, squeezing, twisting,
                               slapping, chopping, and other combinations.
                               ...
                               This was because it gave the most satisfying effect when completed.
                               I then finalized my working model and began sketching plans for the
                               form.'/>
                <ContentBlock body='Most of my initial ideation was based off of a piece of clay
                               I squeezed in my deisred grip. The clay inspired
                               the proportions of the body and the dimensions of my fingers grips.
                               I made quick physical models out of blue foam
                               ...
                               and how it effected the form and appearance of the model.'/>
                <Spacer size={2}/>
                <YTVid ytid='jgTWmM7sVBc' size={4} caption='Process models'/>
                <ContentBlock body='One decision I struggled with was the design of the 
                "buttons", or where the fingers gripped the artifact.
                I wanted to keep them subtle so that the focus was kept on the triangular
            ...
            <div>
                ...
                <TitledContent title='Description'
                               body= 'Design a container to hold at most 1.5L of liquid
                                      ...
                                      Consider how liquid is collected, 
                                      moved, and dispensed from the vessel.'/>
                <ContentBlock body='Three randomly selected words were: heavy, soft, dynamic.
            ...
            <div>
                ...
                <TitledContent title='Description'
                               body= 'Craft primitive forms with various materials that assist 
                                      ...
                                      and material so that the interaction is similar yet
                                      slightly different.'/>
                <TitledContent title='Duration'
                               body= '2 weeks'/>
